...
public class BoardPanel extends JPanel {
	...
	public int checkLines() {
		...
		/*
		 * Loop through every line and check it to see if
	 ...
	 * removes them from the game. Auxiliary method to checkLines().
	 * @return The number of lines that were cleared.
	 */
	private boolean checkLine(int line) {
		...
		/*
		 * Since the line is filled, simply shift every row above it down by one.
		 */
	...
	public void paintComponent(Graphics g) {
		...
		if(tetris.isPaused()) {
			...
			/*
			 * Draws the background grid above the pieces 
			 */
